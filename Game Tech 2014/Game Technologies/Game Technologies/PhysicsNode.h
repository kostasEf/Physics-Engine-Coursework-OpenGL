...
#define LINEAR_VELOCITY_DAMP 0.99
#define ANGULAR_VELOCITY_DAMP 0.99
...
public:
	...
	bool GetSmart() { return tryingToBeSmart; }
	bool GetResting() { return isResting; }
	bool GetProjectile() { return isProjectile; }
	bool GetPig() { return isPig; }
	...
	void	SetSmart(bool value) { tryingToBeSmart = value; }
	void	SetProjectile(bool value) { isProjectile = value; }
	void	SetPig(bool value) { isPig = value; }
	void	SetResting(bool value) { isResting = value; }

	void	SetForce(Vector3 value) { m_force = value; }
